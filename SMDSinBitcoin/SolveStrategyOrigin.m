...
%             Rs{adopt}(i, st2stnumOrigin(1, 0, irrelevant)) = mid1;
%             Rs{adopt}(i, st2stnumOrigin(0, 1, irrelevant)) = mid1;
%             Rh{adopt}(i, st2stnumOrigin(1, 0, irrelevant)) = 0;
%             Rh{adopt}(i, st2stnumOrigin(0, 1, irrelevant)) = 0;
%         elseif h == maxForkLen
...
%             Rs{adopt}(i, st2stnumOrigin(1, 0, irrelevant)) = mid3;
%             Rs{adopt}(i, st2stnumOrigin(0, 1, irrelevant)) = mid3;
%             Rh{adopt}(i, st2stnumOrigin(1, 0, irrelevant)) = 0;
%             Rh{adopt}(i, st2stnumOrigin(0, 1, irrelevant)) = 0;
%         end
%     end
